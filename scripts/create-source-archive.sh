...
required_paths=(
    ...
    "packages/agent/native/win32/process-job.c"
    "packages/agent/native/win32/build.mjs"
    "packages/agent/native/win32/prebuilds/win32-arm64/pi-process-job.exe"
    "packages/agent/native/win32/prebuilds/win32-x64/pi-process-job.exe"
